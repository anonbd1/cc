<?php session_start(); /* Starts the session */
	...
	if(isset($_POST['Submit'])){
		...
		$logins = array('12' => '12','username1' => 'password1','username2' => 'password2');
	...
	<div class="limiter">
		<div class="container-login100" style="background: #5C258D;background: -webkit-linear-gradient(to right, #4389A2, #5C258D);background: linear-gradient(to right, #4389A2, #5C258D);">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form action="" method="post" name="Login_Form" class="login100-form validate-form p-b-33 p-t-5">

					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input name="Username" class="input100" type="text" placeholder="User name">
					...
					<div class="container-login100-form-btn m-t-32">
						<button name="Submit" value="Login" type="submit" id="login-button" class="login100-form-btn">
							Login
						</button>
						<?php if(isset($msg)){?>
			<?php echo $msg;?>
